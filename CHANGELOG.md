...
- 17 MCP tools matching the full CLI: context, seal, spec management, status, diff, log, finish, converge, restore, verify, doctor
...
- 17 slash commands generated by `writ init` in `.claude/commands/`
